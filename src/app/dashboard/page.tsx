    ...
    <DashboardLayout>
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {/* AI 챗봇 */}
          <div
            className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer"
          ...
          {/* 데이터 시각화 */}
          <div
            className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer col-span-1 md:col-span-2"
        ...
        <div className="text-center bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl py-16 px-8">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            각 기능을 최신 AI 기술로 바탕으로 단계별로만든, 여러분의 작업을 더욱 스마트하고
            효율적으로 만들어드립니다.
          </p>
          <button
