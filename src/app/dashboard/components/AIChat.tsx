...
export default function AIChat() {
  ...
  const clearChat = async () => {
    ...
    try {
      ...
      const { error } = await supabase.from('ai_chat').delete().eq('user_id', user.id)
    ...
    <div className="max-w-7xl mx-auto h-[calc(100vh-160px)]">
      ...
      <div className="w-full bg-white rounded-2xl shadow-sm border border-gray-200">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          ...
          <button onClick={clearChat} className="text-gray-500 hover:text-gray-700 text-sm">
            대화 지우기
          </button>
        </div>
